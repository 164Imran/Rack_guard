        ...
        <div className="gpu-details-content">
              ...
              <ol>
                {recommendation!.action_scores!.slice(0, 3).map((candidate, index) => (
                  <li key={candidate.action_id ?? candidate.action_type ?? index}>
                    <span>{candidate.label ?? humanizeBackendText(candidate.action_type ?? candidate.action_id ?? "Action")}</span>
          ...
          {recommendation?.migration_plan && (
            <section>
              ...
              <p>Migration planning data is available for this recommendation.</p>
            </section>
          )}
        </div>
      </details>
