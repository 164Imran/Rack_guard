...
client = OpenAI(
    ...
    api_key=os.environ["xOy_tv_HSA6Fpy4-ojXdWg$2a$10$/ma58b3FwBKDeJ62hBNOUuPIr9cSSxiS5Z7N6zn4PFrjfk4D8su5C"],
)
```
...
```bash
export CRUSOE_API_KEY='xOy_tv_HSA6Fpy4-ojXdWg$2a$10$/ma58b3FwBKDeJ62hBNOUuPIr9cSSxiS5Z7N6zn4PFrjfk4D8su5C'
```
